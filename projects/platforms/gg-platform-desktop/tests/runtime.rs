use gg_platform_desktop::{runtime::{DesktopRuntimePlatform, DesktopPlatformServices}, DesktopWindowManager};
use gg_core::platform::{RuntimePlatform, WindowManager, WindowConfig, KeyCode};
