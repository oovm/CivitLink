...
#![deprecated(
    since = "0.1.0",
    note = "gg-editor-core 已废弃，请迁移至 gg-editor-shell。EditorConfig → gg_editor_shell::EditorConfig, EditorPanel → gg_editor_shell::EditorPanel, EditorEvent → gg_editor_shell::EditorEvent"
)]
