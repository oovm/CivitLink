...
//! GG 引擎脚本编译模块
//! 使用 oak-valkyrie 前端将 Valkyrie 源码编译为 IR
...
/// 脚本编译器，将 Valkyrie 源码编译为 IR 模块
///
/// 编译管线：源码 → ValkyrieBuilder → ValkyrieRoot AST → ValkyrieCompiler → IrModule
