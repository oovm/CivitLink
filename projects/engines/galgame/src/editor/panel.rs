        ...
        match transition {
            ...
            TransitionType::Slide { duration_secs, direction } => {
                let dir = match direction {
                    gg_galgame_schema::components::SlideDirection::Left => "Left",
                    gg_galgame_schema::components::SlideDirection::Right => "Right",
                    gg_galgame_schema::components::SlideDirection::Up => "Up",
                    gg_galgame_schema::components::SlideDirection::Down => "Down",
                };
