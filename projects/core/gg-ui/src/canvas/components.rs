...
impl Default for CanvasRenderer {
    fn default() -> Self {
        Self { cull_transparent_mesh: true, has_mesh: false, material: None }
    }
}
...
impl Default for Graphic {
    fn default() -> Self {
        Self { color: Color::WHITE, raycast_target: true, material: None, texture: None, visible: true }
    }
}
...
impl Clone for Button {
    fn clone(&self) -> Self {
        Self {
            ...
            target_graphic: self.target_graphic,
