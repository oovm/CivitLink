...
fn test_fold_add_constants() {
    ...
    module.add_function(IrFunction {
        ...
        param_count: 0,
        local_count: 0,
        instructions: vec![OpCode::LoadConst(a_idx), OpCode::LoadConst(b_idx), OpCode::Add, OpCode::Return],
    });
...
fn test_fold_not_bool() {
    ...
    module.add_function(IrFunction {
        ...
        param_count: 0,
        local_count: 0,
        instructions: vec![OpCode::LoadConst(idx), OpCode::Not, OpCode::Return],
    });
...
fn test_non_constant_expressions_not_folded() {
    ...
    module.add_function(IrFunction {
        ...
        param_count: 0,
        local_count: 1,
        instructions: vec![OpCode::LoadConst(a_idx), OpCode::LoadLocal(0), OpCode::Add, OpCode::Return],
    });
