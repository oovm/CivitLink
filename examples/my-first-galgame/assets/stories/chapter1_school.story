...
%audio::play("bgm/peaceful_theme.mp3", 0.5)
%scene::change("bg/student_council_room.png", "fade", 1.0)
...
%scene::change("bg/school_hallway.png", "fade", 0.8)
...
%scene::change("bg/school_corridor.png", "fade", 0.8)
...
%audio::play("bgm/mystery_theme.mp3", 0.5)
